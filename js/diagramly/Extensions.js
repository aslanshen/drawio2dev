...
(function()
{
	...
	var arcSize = 6;
	var edgeStyle = 'html=0;jettySize=18;';
	var vertexStyle = 'html=0;overflow=block;blockSpacing=1;';
	var labelStyle = 'text;html=0;resizable=0;labelBackgroundColor=#ffffff;align=center;verticalAlign=middle;';
	...
	var azur19 = 'aspect=fixed;html=0;points=[];align=center;verticalAlign=top;image;image=img/lib/mscae/';
	var gcpIcon = 'html=0;verticalLabelPosition=bottom;verticalAlign=top;strokeColor=none;shape=mxgraph.gcp2.';
	var kupIcon = 'html=0;verticalLabelPosition=bottom;verticalAlign=top;strokeColor=none;shape=mxgraph.kubernetes.icon;prIcon=';
...
//			'VSMHeijyunkaBoxBlock' NA
			...
			'VSMMRPERPBlock' : s + 'lean_mapping.mrp_erp;',
...
// Azure 2019
			...
			'HockeyAppAzure2019' : 'shadow=0;dashed=0;html=0;strokeColor=none;labelPosition=center;verticalLabelPosition=bottom;verticalAlign=top;align=center;shape=mxgraph.mscae.cloud.hockeyapp;fillColor=#0079D6;pointerEvents=1',
			...
			'AzureInformationProtectionAzure2019' : 'aspect=fixed;shadow=0;dashed=0;html=0;strokeColor=none;labelPosition=center;verticalLabelPosition=bottom;verticalAlign=top;align=center;shape=mxgraph.mscae.cloud.azure_rights_management_rms;fillColor=#58B4D9;',
			'IoTCentralApplicationsAzure2019' : 'aspect=fixed;shadow=0;dashed=0;html=0;strokeColor=none;labelPosition=center;verticalLabelPosition=bottom;verticalAlign=top;align=center;shape=mxgraph.mscae.cloud.central;fillColor=#0079D6;pointerEvents=1',
...
//Kubernetes Icons
			...
			'LogoKub19' : 'aspect=fixed;html=0;align=center;image;image=img/lib/mscae/Kubernetes.svg',
...
//Other
	...
	{
		var style = '' + (noLblStyle?
				'overflow=block;blockSpacing=1;html=0;fontSize=' + defaultFontSize + ';' +
				gFontFamilyStyle
				:
	...
	function addAllStyles(style, properties, action, cell, noLblStyle)
	{
		...
		s += '' +
		  (noLblStyle? (hasStyle(style, 'overflow')? '' : 'overflow=block;blockSpacing=1;') +
			(hasStyle(style, 'html')? '' : 'html=0;') + 'fontSize=' + defaultFontSize + ';' +
			gFontFamilyStyle
			:
...
//			}
	...
	function addGCP2ServiceCard(icon, w, h, v, p, a)
	{
	    ...
	    var icon1 = new mxCell(label, new mxGeometry(0, 0.5, 24, 24),
	    		'dashed=0;connectable=0;html=0;strokeColor=none;' + mxConstants.STYLE_SHAPE + '=mxgraph.gcp2.' + icon + ';part=1;shadow=0;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;spacingLeft=5;');
	...
	function addGCP2UserDeviceCard(icon, scaleX, scaleY, w, h, v, p, a)
	{
		...
		v.style = 'rounded=1;absoluteArcSize=1;arcSize=2;verticalAlign=bottom;fillColor=#ffffff;strokeColor=#dddddd;';
		v.style += addAllStyles(v.style, p, a, v);

		v.value = convertText(p);
    	v.vertex = true;
	    var icon1 = new mxCell(null, new mxGeometry(0.5, 0, w * 0.7 * scaleX, w * 0.7 * scaleY),
	    		s + icon + ';part=1;dashed=0;connectable=0;html=0;strokeColor=none;shadow=0;');
		...
		switch (cls)
		{
			...
			case 'UMLSwimLaneBlockV2':
				...
				v.style = (isPool? 'swimlane;startSize=' + mainTxtHeight + ';' : 'fillColor=none;strokeColor=none;pointerEvents=0;fontStyle=0;') +
					'html=0;container=1;collapsible=0;childLayout=stackLayout;' +
				...
				var laneStyle = 'swimlane;html=0;container=1;connectable=0;collapsible=0;fontStyle=0;startSize=' + laneTxtHeight + ';dropTarget=0;rounded=0;' +
			...
			case 'UMLMultidimensionalSwimlane' :
				...
				v.style = 'group;';
				var contStyle = 'fillColor=none;strokeColor=none;html=0;container=1;collapsible=0;childLayout=stackLayout;' +
				...
				var rowStyle = 'swimlane;html=0;container=1;connectable=0;collapsible=0;dropTarget=0;horizontal=0;fontStyle=0;startSize=' + rowStartSize + ';';
				...
				var colStyle = 'swimlane;html=0;container=1;connectable=0;collapsible=0;dropTarget=0;fontStyle=0;startSize=' + colStartSize + ';';
				var x = 0;
			...
			case 'UMLStateBlock' :
				...
				{
					v.style = 'swimlane;startSize=25;html=0;container=1;collapsible=0;childLayout=stackLayout;' +
			...
			case 'GSDFDProcessBlock' :
				...
				v.style = 'shape=swimlane;html=0;rounded=1;arcSize=10;collapsible=0;fontStyle=0;startSize=' + startSize;
			...
			case 'iOSTabs' :
				...
				for (var i = 0; i < numTabs; i++)
				{
					...
					tab[i].style += (isLastLblHTML? 'overflow=block;blockSpacing=1;html=0;fontSize=' + defaultFontSize + ';' +
									gFontFamilyStyle
									:
			...
			case 'iOSSubtitleCell' :
				...
				subtext.style += (isLastLblHTML? 'html=0;fontSize=' + defaultFontSize + ';' +
					gFontFamilyStyle
					:
					getFontSize(p.text) +
			...
			case 'iOSLeftDetailCell' :
				...
				text.style += (isLastLblHTML? 'html=0;fontSize=' + defaultFontSize + ';' +
					gFontFamilyStyle
					:
					getFontSize(p.subtext) +
			...
			case 'iOSTableGroupedSectionBreak' :
				...
				text1.style += (isLastLblHTML? 'html=0;fontSize=' + defaultFontSize + ';' +
					gFontFamilyStyle
					:
					getFontSize(p.text) +
					getFontFamily(p.text) +
				...
				text2.style += (isLastLblHTML? 'html=0;fontSize=' + defaultFontSize + ';' +
					gFontFamilyStyle
					:
			...
			case 'UMLComponentBoxBlockV2':
				v.value = convertText(p);
				v.style = 'html=0;dropTarget=0;' + addAllStyles(v.style, p, a, v, isLastLblHTML);
			...
			case 'BPMNChoreography' :
				try
				{
					...
					var task = new mxCell('', new mxGeometry(0, curY, w, curH), 'part=1;html=0;resizeHeight=0;spacingTop=-1;spacingLeft=3;spacingRight=3;');
					...
					for (var i = 0; i < p.Fields; i++)
					{
						...
						item[i] = new mxCell('', new mxGeometry(0, curY, w, curH), 'part=1;html=0;resizeHeight=0;fillColor=none;spacingTop=-1;spacingLeft=3;spacingRight=3;');
						curY += curH;
						item[i].vertex = true;
						v.insert(item[i]);
	...
	*/
				...
				try
				{
					...
					for (var i = 0; i < rowsNum; i++)
					{
						...
						for (var j = 0; j < colsNum; j++)
						{
							...
							var cell = new mxCell('', new mxGeometry(x, y, cw, ch), 'shape=partialRectangle;html=0;connectable=0;'
			...
			case 'VSMGoSeeProductionBlock' :
				...
				var item1 = new mxCell('', new mxGeometry(w * 0.17, h * 0.2, 13, 6), 'shape=mxgraph.lean_mapping.go_see_production_scheduling;flipH=1;part=1;html=0;');
				item1.vertex = true;
				v.insert(item1);
				item1.style += addAllStyles(item1.style, p, a, item1);
			...
			case 'VSMProductionKanbanBatchBlock' :
				...
				var item3 = new mxCell('', new mxGeometry(0, h * 0.2, w * 0.9, h * 0.8), 'shape=mxgraph.lean_mapping.go_see_production_scheduling;flipH=1;part=1;html=0;spacing=2;' + st);
				item3.vertex = true;
				v.insert(item3);
			...
			case 'NET_RingNetwork' :
				v.style += 'strokeColor=none;fillColor=none;';
			   	...
			   	var cell = new mxCell('', new mxGeometry(w * 0.25, h * 0.25, w * 0.5, h * 0.5), 'ellipse;html=0;strokeColor=#29AAE1;strokeWidth=2;');
			   	cell.vertex = true;
			   	v.insert(cell);
			   	var cells = [cell];
			   	cell.style += getFillColor(p, a);

			   	var edge = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=none;rounded=0;endArrow=none;dashed=0;html=0;strokeColor=#29AAE1;strokeWidth=2;');
			...
			case 'NET_Ethernet' :
				...
				var edge = new mxCell('', new mxGeometry(0, 0, 0, 0), 'strokeColor=#29AAE1;edgeStyle=none;rounded=0;endArrow=none;html=0;strokeWidth=2;');
				edge.geometry.relative = true;
				edge.edge = true;
			...
			case 'EIGuaranteedDeliveryBlock' :
				...
				item1.style += addAllStyles(item1.style, p, a, item1);
			   	...
			   	var edge = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=none;rounded=0;endArrow=block;dashed=0;html=0;strokeColor=#818181;strokeWidth=1;endFill=1;endSize=6;');
			   	edge.geometry.relative = true;
		    	edge.edge = true;
			...
			case 'EIChannelAdapterBlock' :
				...
				edge1 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;rounded=0;exitX=1;exitY=0.5;entryX=0;entryY=0.5;endArrow=none;dashed=0;html=0;strokeWidth=1;endFill=1;endSize=2;');
				...
				edge2 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;rounded=0;exitX=1;exitY=0.5;entryX=0;entryY=0.5;endArrow=block;startArrow=block;dashed=0;html=0;strokeColor=#818181;strokeWidth=1;endFill=1;endSize=2;startFill=1;startSize=2;');
			...
			case 'EIEventMessageBlock' :
				...
				for (var i = 0; i < messagesNum; i++)
				{
					...
					edge[i] = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;rounded=0;exitX=0;exitY=0.5;endArrow=none;dashed=0;html=0;');
			...
			case 'EIPublishSubscribeChannelBlock' :
		    	...
		    	v.style += addAllStyles(v.style, p, a, v, isLastLblHTML);
			   	...
			   	var edge1 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=none;rounded=0;endArrow=block;dashed=0;html=0;strokeColor=#818181;strokeWidth=1;endFill=1;endSize=6;');
			   	edge1.geometry.relative = true;
		    	edge1.edge = true;
		    	addFloatingEdge(w * 0.05, h * 0.5, w * 0.85, h * 0.5, edge1, select, graph, cells, v, cell);

			   	var edge2 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=elbowEdgeStyle;rounded=0;endArrow=block;dashed=0;html=0;strokeColor=#818181;strokeWidth=1;endFill=1;endSize=6;');
			   	edge2.geometry.relative = true;
		    	edge2.edge = true;
		    	addFloatingEdge(w * 0.05, h * 0.5, w * 0.85, h * 0.15, edge2, select, graph, cells, v, cell);

			   	var edge3 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=elbowEdgeStyle;rounded=0;endArrow=block;dashed=0;html=0;strokeColor=#818181;strokeWidth=1;endFill=1;endSize=6;');
			...
			case 'EIMessageBusBlock' :
		    	...
		    	v.style += addAllStyles(v.style, p, a, v, isLastLblHTML);
			   	...
			   	var edge1 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=none;rounded=0;endArrow=block;dashed=0;html=0;strokeWidth=1;endFill=1;endSize=4;startArrow=block;startFill=1;startSize=4;');
			   	edge1.geometry.relative = true;
		    	edge1.edge = true;
		    	edge1.style += getStrokeColor(p, a);
		    	addFloatingEdge(w * 0.05, h * 0.5, w * 0.95, h * 0.5, edge1, select, graph, cells, v, cell);

			   	var edge2 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=elbowEdgeStyle;rounded=0;endArrow=block;dashed=0;html=0;strokeWidth=1;endFill=1;endSize=4;startArrow=block;startFill=1;startSize=4;');
			   	edge2.geometry.relative = true;
		    	edge2.edge = true;
		    	edge2.style += getStrokeColor(p, a);
		    	addFloatingEdge(w * 0.3, h * 0.1, w * 0.3, h * 0.5, edge2, select, graph, cells, v, cell);

			   	var edge3 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=elbowEdgeStyle;rounded=0;endArrow=block;dashed=0;html=0;strokeWidth=1;endFill=1;endSize=4;startArrow=block;startFill=1;startSize=4;');
			   	edge3.geometry.relative = true;
		    	edge3.edge = true;
		    	edge3.style += getStrokeColor(p, a);
		    	addFloatingEdge(w * 0.7, h * 0.1, w * 0.7, h * 0.5, edge3, select, graph, cells, v, cell);

			   	var edge4 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=elbowEdgeStyle;rounded=0;endArrow=block;dashed=0;html=0;strokeWidth=1;endFill=1;endSize=4;startArrow=block;startFill=1;startSize=4;');
			...
			case 'EIRequestReplyBlock' :
				...
				item2.style += addAllStyles(item2.style, p, a, item2);
			   	...
			   	var edge2 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=none;rounded=0;endArrow=block;dashed=0;html=0;strokeColor=#818181;strokeWidth=1;endFill=1;endSize=6;');
			   	edge2.geometry.relative = true;
		    	edge2.edge = true;
			...
			case 'EICorrelationIDBlock' :
				...
				edge1 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;rounded=0;exitX=0;exitY=0.5;endArrow=none;dashed=0;html=0;part=1;');
		    	edge1.geometry.relative = true;
		    	edge1.edge = true;
				...
				edge2 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;rounded=0;exitX=0;exitY=0.5;endArrow=none;dashed=0;html=0;part=1;');
		    	edge2.geometry.relative = true;
		    	edge2.edge = true;
		    	item3.insertEdge(edge2, false);
			...
			case 'EIMessageSequenceBlock' :
				...
				var edge1 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'curved=1;endArrow=block;html=0;endSize=3;part=1;');
				item1.insertEdge(edge1, false);
				item2.insertEdge(edge1, true);
				...
				var edge2 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'curved=1;endArrow=block;html=0;endSize=3;part=1;');
			...
			case 'EIMessageHistoryBlock' :
				...
				edge3 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;rounded=0;exitX=0;exitY=0.5;endArrow=none;dashed=0;html=0;');
		    	edge3.geometry.relative = true;
		    	edge3.edge = true;
		    	item1.insertEdge(edge3, false);
		    	item3.insertEdge(edge3, true);
				...
				edge4 = new mxCell('', new mxGeometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;rounded=0;exitX=0;exitY=0.5;endArrow=none;dashed=0;html=0;');
		    	edge4.geometry.relative = true;
		    	edge4.edge = true;
			...
			case 'UI2DialogBlock' :
				...
				var item2 = new mxCell('', new mxGeometry(1, 0.5, 20, 20), 'ellipse;part=1;strokeColor=#008cff;resizable=0;fillColor=none;html=0;');
			   	item2.geometry.relative = true;
			...
			case 'UI2TableBlock' :
				...
				try
				{
					...
					v.style = 'html=0;overflow=fill;verticalAlign=top;spacing=0;';
			...
			case 'UI2ContextMenuBlock' :
				...
				for (var i = 0; i < p.Lines; i++)
				{
					...
					if (p['Item_' + (i + 1)] != null)
					{
						...
						item[i] = new mxCell('', new mxGeometry(0, i * h / p.Lines, w, itemH), 'strokeColor=none;fillColor=none;spacingLeft=20;align=left;html=0;');
						item[i].vertex = true;
						v.insert(item[i]);
						item[i].style += st;
					...
					if (p['Shortcut_' + (i + 1)] != null)
					{
						...
						shortcut[i] = new mxCell('', new mxGeometry(w * 0.6, i * h / p.Lines, w * 0.4, itemH), 'strokeColor=none;fillColor=none;spacingRight=3;align=right;html=0;');
			...
			case 'UI2TooltipSquareBlock' :
				...
				v.style += 'html=0;shape=callout;flipV=1;base=13;size=7;position=0.5;position2=0.66;rounded=1;arcSize=' + (p.RoundCorners) + ';' +
			...
			case 'UI2AlertBlock' :
				...
				{
					item3[i] = new mxCell('', new mxGeometry(0.5, 1, bw, bh), 'part=1;html=0;');
			...
			case 'UMLClassBlock' :
				if (p.Simple == 0)
				{
					...
					for (var i = 0; i <= p.Attributes; i++)
					{
						...
						item[i] = new mxCell('', new mxGeometry(0, curY, w, curH), 'part=1;html=0;resizeHeight=0;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
						curY += curH;
						item[i].vertex = true;
						v.insert(item[i]);
						item[i].style += st +
			...
			case 'ERDEntityBlock' :
				...
				for (var i = 0; i < p.Fields; i++)
				{
					...
					item[i] = new mxCell('', new mxGeometry(0, curY, w, curH), 'part=1;resizeHeight=0;strokeColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;html=0;');
					curY += curH;
					item[i].vertex = true;
					v.insert(item[i]);
					item[i].style += st +
			...
			case 'ERDEntityBlock2' :
				...
				for (var i = 0; i < p.Fields; i++)
				{
					...
					key[i] = new mxCell('', new mxGeometry(0, currH, keyW, p['Key' + (i + 1) + '_h'] * scale), 'strokeColor=none;part=1;resizeHeight=0;align=center;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;html=0;');
					key[i].vertex = true;
					v.insert(key[i]);
					key[i].style += st +
					...
					item[i] = new mxCell('', new mxGeometry(keyW, currH, w - keyW, p['Field' + (i + 1) + '_h'] * scale), 'shape=partialRectangle;top=0;right=0;bottom=0;part=1;resizeHeight=0;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;html=0;');
					item[i].vertex = true;
					v.insert(item[i]);
					item[i].style += st +
						getFontSize(p['Field' + (i + 1)]) +
...
//				break;
			...
			case 'FreehandBlock':
				try
				{
					...
					{
						var img = new mxCell('', new mxGeometry(0, 0, w, h), 'shape=image;html=0;');
			...
			case 'PersonRoleBlock' :
				try
				{
					...
					var name = new mxCell('', new mxGeometry(0, h/2, w, h/2), 'part=1;html=0;resizeHeight=0;spacingTop=-1;spacingLeft=3;spacingRight=3;');
