(function () {
    /**
     *从以下网址下载TSV，并使用 https://jgraph.github.io/drawio-tools/tools/convert.html:转换
    ...
    /**
     * To update this, go to https://test.draw.io/?dev=1&test=1&drawdev=1&demo=1&createindex=1 和
     *将搜索文件数据的输出从浏览器控制台复制到下面的变量中。
     */
    ...
    /**
     * 定制库的描述，请参见 https://www.diagrams.net/doc/faq/configure-diagram-editor
     */
    Sidebar.prototype.customEntries = null;

    /**
     *在更多形状对话框中启用内置库的字符串数组。 Null表示所有，
     * 空数组表示无，列出libs参数的可能键，位于
     *
    ...
    Sidebar.prototype.configuration = [
        ...
        {id: 'uml'}, {id: 'uml25'}, {id: 'search'}, {id: 'er'},
        {
            id: 'azure2',
            prefix: 'azure2',
            libs: ['AI Machine Learning', 'Analytics', 'App Services', 'Azure Stack', 'Azure VMware Solution', 'Blockchain', 'Compute', 'Containers', 'CXP', 'Databases', 'DevOps', 'General', 'Identity', 'Integration', 'Internet of Things', 'Intune', 'IoT', 'Management Governance', 'Migrate', 'Mixed Reality', 'Monitor', 'Networking', 'Other', 'Preview', 'Security', 'Storage', 'Web']
        },
        {id: 'ios', prefix: 'ios', libs: [''/*prefix is library*/, '7icons', '7ui']},
        {id: 'android', prefix: 'android', libs: [''/*prefix is library*/]}, {id: /*'aws3d'*/'medicalEquipment'},
        /*{id: 'flowchart'},*/ {id: /*'basic'*/'animalOrgans'}, {id: /*'infographic'*/'plantOrgans'}, /*{id: 'arrows'},*/ {id: 'arrows2'}, {id: /*'lean_mapping'*/'drawio'}, {id: 'citrix'}, {id: 'azure'}, {id: 'network'}, {id: 'vvd'},
        {id: /*'sitemap'*/'molecular'}, {id: /*'c4'*/'processDiagram'}, {id: /*'dfd'*/'prokaryotes'}, {id: /*'threatModeling'*/'protist'}, {id: /*'kubernetes'*/'virus'}, {
            id: 'cisco19',
            prefix: 'cisco19',
...
//可以创建链接来仅显示指定的库
    ...
    Sidebar.prototype.init = function () {
        //设置更多图形
        // 定义侧边栏的所有条目。这在 MoreShapes 对话框中使用。使用 savesidebar URL 参数创建屏幕截图和
        // http://www.alderg.com/merge.html 如果多个侧边栏是条目的一部分，则用于创建 PNG 图像的垂直堆栈。
        // this.entries = [
        // //     {
        // //     title: mxResources.get('standard'),
        // //     entries: [{title: mxResources.get('general'), id: 'general', image: IMAGE_PATH + '/sidebar-general.png'},
        // //         {title: mxResources.get('arrows'), id: 'arrows', image: IMAGE_PATH + '/sidebar-arrows.png'}],
        // // },
        // {
        //     title: mxResources.get('biography'),
        //     entries: [{title: mxResources.get('animalOrgans'), id: 'animalOrgans', image: IMAGE_PATH + '/sidebar-animalOrgans.png'},
        //         {title: mxResources.get('plantOrgans'), id: 'plantOrgans', image: IMAGE_PATH + '/sidebar-plantOrgans.png'},
        //         {title: mxResources.get('medicalEquipment'), id: 'medicalEquipment', image: IMAGE_PATH + '/sidebar-medicalEquipment.png'},
        //         {title: mxResources.get('molecular'), id: 'molecular', image: IMAGE_PATH + '/sidebar-molecular.png'},
        //         // {title: mxResources.get('flowchart'), id: 'flowchart', image: IMAGE_PATH + '/sidebar-flowchart.png'},
        //         {title: mxResources.get('processDiagram'), id: 'processDiagram', image: IMAGE_PATH + '/sidebar-processDiagram.png'},
        //         {title: mxResources.get('prokaryotes'), id: 'prokaryotes', image: IMAGE_PATH + '/sidebar-prokaryotes.png'},
        //         {title: mxResources.get('protist'), id: 'protist', image: IMAGE_PATH + '/sidebar-protist.png'},
        //         {title: mxResources.get('virus'), id: 'virus', image: IMAGE_PATH + '/sidebar-virus.png'}]
        // },
        // ];
        this.entries = [];
            // 改用 search.xml 索引文件（更快的加载时间）
        ...
        // // 从服务器获取图形信息
        // this.fetchGraphsFromServer();

        this.initPalettes();
    }

    // Sidebar.prototype.fetchGraphsFromServer = function(frontPath = '/') {
    ...
    //         var entries = [];
    //         for (var file of res.datas.datas) {
    //             entries.push({title: mxResources.get(file.fileType), id: file.fileType, image: IMAGE_PATH + '/sidebar-active_directory.png'});
    //         }
    //          // 更新侧边栏的 UI 来显示新的图形信息
    //     that.updateAddEntry(entries);

    //     }, function(jqXHR, textStatus, errorThrown) {
    //          // 请求失败时的处理
    //         console.error('Error fetching graphs:', textStatus, errorThrown);
    //     });
    // };
    
    // Sidebar.prototype.updateAddEntry = function(entries) {
    //     // 找到 "Add" 条目所在的位置
    //     var addEntryIndex = this.entries.findIndex(entry => entry.title === mxResources.get('Add'));
    
    //     // 如果找到了 "Add" 条目
    //     if (addEntryIndex !== -1) {
    //         // 更新 "Add" 条目下的子条目
    //         this.entries[addEntryIndex].entries = entries;
    //     } else {
    //         // 如果没有找到 "Add" 条目，可能需要添加一个新的 "Add" 条目
    //         this.entries.push({
    //             title: mxResources.get('Add'),
    //             entries: entries
    //         });
    //     }
    // };
    ...
    Sidebar.prototype.initPalettes = function () {
        ...
        //设置  右侧布局   try  catch  防止方法调用不了导致程序初始化失败
        // try {
            ...
            if (size != null && url != null) {
                (mxUtils.bind(this, function (s, u) {
                    results.push(mxUtils.bind(this, function () {
                        return this.createVertexTemplate('shape=image;html=0;verticalAlign=top;' +
