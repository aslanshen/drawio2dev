...
//				console.log(mlStyleObj);
				...
				{
					var cell2 = new mxCell('', new mxGeometry(0.5, 1, 10, 10), 'html=0;shape=parallelMarker;');
					cell2.vertex = true;
				...
				{
					var cell1 = new mxCell('', new mxGeometry(0, 0, 10, 10), 'html=0;shape=singleArrow;arrowWidth=0.4;arrowSize=0.4;');
					cell1.vertex = true;
				...
				{
					var cell1 = new mxCell('', new mxGeometry(0, 0, 10, 10), 'html=0;shape=singleArrow;arrowWidth=0.4;arrowSize=0.4;fillColor=#000000;');
					cell1.vertex = true;
					cell1.geometry.relative = true;
					cell1.geometry.offset = new mxPoint(2, 2);
					node.insert(cell1);
...
//			console.log(lbl);
	...
	for (var i = 0; i < lblTxts.length; i++)
	{
		if (lblTxts[i])
		{
			...
			var lblCell = new mxCell(lblTxts[i], new mxGeometry(0, 0, geo.width, geo.height), 'text;html=0;spacing=0;' + this.styleMap2Str(lblStyles[i]));
			lblCell.vertex = true;
