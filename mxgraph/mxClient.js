...
var mxEffects = {
    ...
    mxUtils = {
        ...
        getPrettyXml: function (a, b, c, d, e) {
            ...
            a.setAttribute("xmlns", a.namespaceURI)), a.nodeType == mxConstants.NODETYPE_DOCUMENT) f.push(mxUtils.getPrettyXml(a.documentElement, b, c, d, e)); else if (a.nodeType == mxConstants.NODETYPE_DOCUMENT_FRAGMENT) {
                var g = a.firstChild;
                if (null != g) for (; null != g;) f.push(mxUtils.getPrettyXml(g, b, c, d, e)), g = g.nextSibling
            } else if (a.nodeType == mxConstants.NODETYPE_COMMENT) a = mxUtils.getTextContent(a), 0 < a.length && f.push(c + "\x3c!--" + a + "--\x3e" + d); else if (a.nodeType == mxConstants.NODETYPE_TEXT) a = mxUtils.trim(mxUtils.getTextContent(a)),
            0 < a.length && f.push(c + mxUtils.htmlEntities(a, !1) + d); else if (a.nodeType == mxConstants.NODETYPE_CDATA) a = mxUtils.getTextContent(a), 0 < a.length && f.push(c + "<![CDATA[" + a + "]]" + d); else {
                f.push(c + "<" + a.nodeName);
                g = a.attributes;
        ...
        fit: function (a) {
            var b = mxUtils.getDocumentSize(), c = parseInt(a.offsetLeft), d = parseInt(a.offsetWidth),
        ...
        arcToCurves: function (a, b, c, d, e, f, g, k, l) {
            ...
            c = Math.abs(c);
            d = Math.abs(d);
            var m = -k / 2, n = -l / 2, p = Math.cos(e * Math.PI /
                180), q = Math.sin(e * Math.PI / 180);
            e = p * m + q * n;
            var m = -1 * q * m + p * n, n = e * e, r = m * m, t = c * c, u = d * d, x = n / t + r / u;
            ...
            for (var y = Math.cos(f), B = Math.sin(f), r = -m * (n * B + d * y), t = -m * (c * B - p * y), q = [], A = 0; A < g; ++A) {
                f += e;
                var y = Math.cos(f), B = Math.sin(f), u = n * y - d * B + k, x = c * y + p * B + l,
                    z = -m * (n * B + d * y), y = -m * (c * B - p * y), B = 6 * A;
                q[B] = Number(r + a);
                q[B + 1] = Number(t + b);
                q[B + 2] = Number(u - z + a);
                q[B + 3] = Number(x - y + b);
        ...
        intersectsHotspot: function (a, b, c, d, e, f) {
            ...
            f ? f : 0;
            if (0 < d) {
                var g = a.getCenterX(), k = a.getCenterY(), l = a.width, m = a.height,
        ...
        indexOfStylename: function (a, b) {
            if (null !=
                a && null != b) for (var c = a.split(";"), d = 0, e = 0; e < c.length; e++) {
                if (c[e] == b) return d;
                d += c[e].length + 1
            }
            return -1
        ...
        getScaleForPageCount: function (a, b, c, d) {
            ...
            for (f = 0; g > a;) {
                var g = Math.floor(c) / c, k = Math.floor(d) / d;
            ...
            if (mxClient.IS_SF && !mxClient.IS_TOUCH) {
                ...
                mxEvent.addGestureListeners(b, mxUtils.bind(this, function (a) {
                    ...
                    if (!mxEvent.isMouseEvent(b) && 2 == d.length) {
                        for (var c = 0; c < d.length; c++) if (b.pointerId == d[c].pointerId) {
                            d[c] = b;
                            break
                        }
                        b = Math.abs(d[0].clientX - d[1].clientX);
                        var c = Math.abs(d[0].clientY - d[1].clientY), g = Math.abs(b - e), m = Math.abs(c - f);
...
mxWindow.prototype.installMinimizeHandler = function () {
    ...
    var a = !1, b = null, c = null, d = mxUtils.bind(this, function (d) {
        ...
        if (a) a = !1, this.minimize.setAttribute("src", this.minimizeImage), this.minimize.setAttribute("title",
            "Minimize"), this.contentWrapper.style.display = "", this.maximize.style.display = b, this.div.style.height = c, this.table.style.height = c, null != this.resize && (this.resize.style.visibility = ""), this.fireEvent(new mxEventObject(mxEvent.NORMALIZE, "event", d)); else {
            a = !0;
            ...
            0 < e.height && (this.div.style.height = e.height + "px", this.table.style.height = e.height + "px");
            0 < e.width && (this.div.style.width = e.width + "px", this.table.style.width = e.width + "px");
    ...
    var a = !1, b = null, c = null, d = null, e = null, f = null, g = mxUtils.bind(this, function (g) {
        ...
        if ("none" != this.maximize.style.display) {
            if (a) {
                ...
                k = Math.max(document.body.clientHeight ||
                    0, document.documentElement.clientHeight || 0);
...
mxPopupMenu.prototype.showSubmenu = function (a, b) {
    if (null != b.div) {
        ...
        var c = parseInt(b.div.offsetLeft), d = parseInt(b.div.offsetWidth),
            e = mxUtils.getDocumentScrollOrigin(document), f = document.documentElement;
...
mxSvgCanvas2D.prototype.updateFill = function () {
    ...
    if (null != a.fillColor) if (null != a.gradientColor) if (a = this.getSvgGradient(String(a.fillColor), String(a.gradientColor), a.gradientFillAlpha, a.gradientAlpha, a.gradientDirection), this.root.ownerDocument == document && this.useAbsoluteIds) {
...
mxSvgCanvas2D.createCss = function (a, b, c, d, e, f, g, k, l, m, n, p, q) {
    ...
    c = "overflow: hidden; ";
    var t = "width: 1px; ", u = "height: 1px; ", x = r.x * a, r = r.y * b;
...
mxGuide.prototype.move = function (a, b, c, d) {
    if (null != this.states && (this.horizontal || this.vertical) && null != a && null != b) {
        ...
        var e = function (c, d, e) {
            ...
            k = k || f
        }, f = this.graph.getView().scale, f = this.getGuideTolerance(c) * f, g = a.clone();
        g.x += b.x;
        g.y += b.y;
...
mxShape.prototype.getWaypoints = function () {
    var a = this.points, b = null;
    if (null != a && (b = [], 0 < a.length)) {
        var c = this.scale, d = Math.max(c, 1), e = a[0];
...
mxArrowConnector.prototype.paintEdgeShape = function (a, b) {
    ...
    var d = this.getStartArrowWidth() + c, e = this.getEndArrowWidth() + c,
        f = this.outline ? this.getEdgeWidth() + c : this.getEdgeWidth(), g = this.isOpenEnded(),
        k = this.isMarkerStart(), l = this.isMarkerEnd(), m = g ? 0 : this.arrowSpacing + c / 2, n = this.startSize + c,
        c = this.endSize + c, p = this.isArrowRounded(), q = b[b.length - 1], r = b[1].x - b[0].x, t = b[1].y - b[0].y,
        u = Math.sqrt(r * r + t * t);
    if (0 != u) {
        var x = r / u, y, B = x, A = t / u, z, C = A, u = f * A, v = -f * x, D = [];
        ...
        for (var E = z = y = 0, u = 0; u < b.length - 2; u++) if (v = mxUtils.relativeCcw(b[u].x, b[u].y, b[u + 1].x, b[u + 1].y, b[u + 2].x, b[u + 2].y), y = b[u + 2].x - b[u + 1].x,
...
mxText.prototype.paint = function (a, b) {
    ...
    if (b) a.updateText(d, e, f, c, this.align, this.valign, this.wrap, this.overflow, this.clipped, this.getTextRotation(), this.node); else {
        var g = mxUtils.isNode(this.value) || this.dialect == mxConstants.DIALECT_STRICTHTML, k = g ? "html" : "",
            l = this.value;
...
mxText.prototype.fixFlexboxForIe11 = function (a) {
    ...
    if (!this.wrap) for (b = a.querySelectorAll('div[style*="display: flex; justify-content: center;"]'), a = -window.innerWidth, c = 0; c < b.length; c++) b[c].style.marginLeft = a + "px", b[c].style.marginRight = a + "px"
};
...
mxText.prototype.updateHtmlFilter = function () {
    ...
    var g = f * d, l = l * d, m = this.getTextRotation() * (Math.PI / 180);
    ...
    m > Math.PI / 2 && (m =
        Math.PI - m);
    var k = Math.cos(m), n = Math.sin(-m), b = l * -(b + .5), c = g * -(c + .5);
...
mxConnector.prototype.createMarker = function (a, b, c) {
    var d = null, e = b.length,
        ...
        g = c ? b[1] : b[e - 2];
    b = c ? b[0] : b[e - 1];
    if (null != f && null != g && null != b) var d = b.x - g.x, e = b.y - g.y, k = Math.sqrt(d * d + e * e), g = d / k,
        d = e / k,
...
mxSwimlane.prototype.paintSwimlane = function (a, b, c, d, e, f, g, k) {
    ...
    l || null != this.fill && this.fill != mxConstants.NONE || (a.pointerEvents = !1);
    this.isHorizontal() ? (a.moveTo(0, f), a.lineTo(0, 0), a.lineTo(d, 0), a.lineTo(d, f), a.fillAndStroke(), f < e && (g != mxConstants.NONE && l || (a.pointerEvents = !1), g != mxConstants.NONE && a.setFillColor(g), a.begin(), a.moveTo(0, f), a.lineTo(0, e), a.lineTo(d, e), a.lineTo(d, f), g == mxConstants.NONE ?
        a.stroke() : a.fillAndStroke())) : (a.moveTo(f, 0), a.lineTo(0, 0), a.lineTo(0, e), a.lineTo(f, e), a.fillAndStroke(), f < d && (g != mxConstants.NONE && l || (a.pointerEvents = !1), g != mxConstants.NONE && a.setFillColor(g), a.begin(), a.moveTo(f, 0), a.lineTo(d, 0), a.lineTo(d, e), a.lineTo(f, e), g == mxConstants.NONE ? a.stroke() : a.fillAndStroke()));
...
mxSwimlane.prototype.paintRoundedSwimlane = function (a, b, c, d, e, f, g, k, l) {
    ...
    m || null != this.fill && this.fill != mxConstants.NONE || (a.pointerEvents = !1);
    this.isHorizontal() ? (a.moveTo(d, f), a.lineTo(d, g), a.quadTo(d, 0, d - Math.min(d / 2, g), 0), a.lineTo(Math.min(d / 2, g), 0), a.quadTo(0, 0, 0, g), a.lineTo(0, f), a.fillAndStroke(), f < e && (k != mxConstants.NONE && m || (a.pointerEvents = !1), k != mxConstants.NONE && a.setFillColor(k),
        ...
        Math.min(e / 2, g)), a.quadTo(d, 0, d - g, 0), a.lineTo(f, 0), k == mxConstants.NONE ? a.stroke() : a.fillAndStroke()));
    ...
    try {
        for (var c = 0, d = null, e = null, f = [], g = b.getChildCount(a), k = 0; k < g; k++) {
            ...
            if (this.isVertexIgnored(l)) this.isEdgeIgnored(l) || (this.resetEdges && this.graph.resetEdge(l), this.disableEdgeStyle && this.setEdgeStyleEnabled(l, !1)); else {
                f.push(l);
                var m = this.getVertexBounds(l), d = null == d ? m.y : Math.min(d, m.y),
                    e = null == e ? m.x : Math.min(e, m.x), c = Math.max(c, Math.max(m.width, m.height))
            }
        }
...
mxParallelEdgeLayout.prototype.findParallels = function (a, b) {
    var c = [], d = mxUtils.bind(this, function (a) {
        if (!this.isEdgeIgnored(a)) {
            var b = this.getEdgeId(a);
            null != b && (null == c[b] && (c[b] = []), c[b].push(a))
        }
    });
    if (null != b) for (var e = 0; e < b.length; e++) d(b[e]); else for (var f = this.graph.getModel(), g = f.getChildCount(a), e = 0; e < g; e++) d(f.getChildAt(a, e));
    return c
};
mxParallelEdgeLayout.prototype.getEdgeId = function (a) {
    var b = this.graph.getView(), c = b.getVisibleTerminal(a, !0), b = b.getVisibleTerminal(a, !1), d = "";
    if (null != c && null != b) {
...
mxCoordinateAssignment.prototype.minNode = function (a) {
    ...
    for (f = 0; 0 < b.length && f <= a;) {
        var g = b.shift(), e = g.cell, l = g.weightedValue, m = parseInt(g.rankIndex),
            k = e.getNextLayerConnectedCells(l), n = e.getPreviousLayerConnectedCells(l), p = k.length, q = n.length,
            r = this.medianXValue(k, l + 1), t = this.medianXValue(n,
...
mxSwimlaneLayout.prototype.updateGroupBounds = function () {
    ...
    for (e = 0; e < this.swimlanes.length; e++) if (f = this.swimlanes[e], c = this.graph.getCellGeometry(f), null != c) {
        var g = this.graph.getChildCells(f),
            d = this.graph.isSwimlane(f) ? this.graph.getStartSize(f) : new mxRectangle, k = c.clone(),
            l = d.width + (0 == e ? this.parentBorder : this.interRankCellSpacing / 2), m = b[e].x - l,
...
mxGraphModel.prototype.updateEdgeParent = function (a, b) {
    ...
    c)) {
        ...
        if (null != d) {
            var e = this.getOrigin(this.getParent(a)), f = this.getOrigin(c), g = f.x - e.x, e = f.y - e.y,
                d = d.clone();
            d.translate(-g, -e);
...
var mxCellPath = {
    ...
    RectanglePerimeter: function (a, b, c, d) {
        b = a.getCenterX();
        var e = a.getCenterY(), f = Math.atan2(c.y - e, c.x - b), g = new mxPoint(0, 0), k = Math.PI,
            l = Math.PI / 2 - f, m = Math.atan2(a.height, a.width);
...
mxPrintPreview.prototype.open = function (a, b, c, d) {
    ...
    try {
        ...
        var r = this.pageFormat.width - 2 * this.border, t = this.pageFormat.height -
            2 * this.border;
        ...
        if (null != A) for (var z = 0; z < A.length; z++) B(A[z], !0);
        ...
        if (null != C) for (z = 0; z < C.length; z++) B(C[z], z <
            C.length - 1);
...
mxCellEditor.prototype.resize = function () {
    ...
    if (null == a) this.stopEditing(!0); else if (null != this.textarea) {
        ...
        if (this.autoSize && "fill" != a.style[mxConstants.STYLE_OVERFLOW]) {
            ...
            } else this.textarea.style.maxWidth = e + "px"; else this.textarea.style.whiteSpace = "nowrap", this.textarea.style.width = "";
...
mxCellEditor.prototype.getEditorBounds = function (a) {
    var b = this.graph.getModel().isEdge(a.cell), c = this.graph.getView().scale, d = this.getMinimumSize(a),
        e = d.width, d = d.height;
...
mxCellRenderer.prototype.rotateLabelBounds = function (a, b) {
    ...
    if (!this.legacySpacing || "fill" != a.style[mxConstants.STYLE_OVERFLOW] && "width" != a.style[mxConstants.STYLE_OVERFLOW] && ("block" != a.style[mxConstants.STYLE_OVERFLOW] || "1" == a.style[mxConstants.STYLE_BLOCK_SPACING])) {
        var c = a.view.scale, d = a.text.getSpacing("1" == a.style[mxConstants.STYLE_BLOCK_SPACING]);
        b.x += d.x * c;
        b.y += d.y * c;
...
var mxEdgeStyle = {
    ...
    ElbowConnector: function (a, b, c, d, e) {
        ...
        if (null != b && null != c) if (null != f) var l = Math.min(b.x, c.x),
            m = Math.max(b.x + b.width, c.x + c.width), k = Math.min(b.y, c.y),
            n = Math.max(b.y + b.height, c.y + c.height), f = a.view.transformControlPoint(a, f),
            g = f.y < k || f.y > n,
    ...
    SegmentConnector: function (a, b, c, d, e) {
        ...
        if (null != d && 0 < d.length) {
            ...
            null != d && (u = null);
            for (r = 0; 2 > r; r++) {
                var B = null != d && d.x == x.x, A = null != d && d.y == x.y,
                    z = null != u && x.y >= u.y && x.y <= u.y + u.height,
                    u = null != u && x.x >= u.x && x.x <= u.x + u.width, x = A || null == d && z,
                    y = B || null == d && u;
                if (0 != r || !(x && y || B && A)) {
                    if (null != d && !A && !B && (z || u)) {
                        l = z ? !1 : !0;
    ...
    routePatterns: [[[513, 2308, 2081, 2562], [513, 1090, 514, 2184, 2114, 2561], [513, 1090, 514, 2564, 2184, 2562], [513, 2308, 2561, 1090, 514, 2568, 2308]], [[514, 1057, 513, 2308, 2081, 2562], [514, 2184, 2114, 2561], [514, 2184, 2562, 1057, 513, 2564, 2184], [514, 1057, 513, 2568,
        2308, 2561]], [[1090, 514, 1057, 513, 2308, 2081, 2562], [2114, 2561], [1090, 2562, 1057, 513, 2564, 2184], [1090, 514, 1057, 513, 2308, 2561, 2568]], [[2081, 2562], [1057, 513, 1090, 514, 2184, 2114, 2561], [1057, 513, 1090, 514, 2184, 2562, 2564], [1057, 2561, 1090, 514, 2568, 2308]]],
    ...
    getJettySize: function (a, b) {
        ...
        "auto" == c && (mxUtils.getValue(a.style, b ? mxConstants.STYLE_STARTARROW : mxConstants.STYLE_ENDARROW, mxConstants.NONE) != mxConstants.NONE ? (c = mxUtils.getNumber(a.style,
            b ? mxConstants.STYLE_STARTSIZE : mxConstants.STYLE_ENDSIZE, mxConstants.DEFAULT_MARKERSIZE), c = Math.max(2, Math.ceil((c + mxEdgeStyle.orthBuffer) / mxEdgeStyle.orthBuffer)) * mxEdgeStyle.orthBuffer) : c = 2 * mxEdgeStyle.orthBuffer);
        return c
    },
    ...
    scaleCellState: function (a, b) {
        var c;
        null != a ? (c = a.clone(), c.setRect(Math.round(a.x /
            b * 10) / 10, Math.round(a.y / b * 10) / 10, Math.round(a.width / b * 10) / 10, Math.round(a.height / b * 10) / 10)) : c = null;
        return c
    },
    OrthConnector: function (a, b, c, d, e) {
        var f = a.view.graph, g = null == l ? !1 : f.getModel().isEdge(l.cell),
            ...
            u = null != l ? l.height : 0, x = null !=
            m ? m.x : p.x, y = null != m ? m.y : p.y, B = null != m ? m.width : 0, A = null != m ? m.height : 0,
            f = mxEdgeStyle.getJettySize(a, !0), z = mxEdgeStyle.getJettySize(a, !1);
        ...
        if (v || mxEdgeStyle.orthPointsFallback && null != d && 0 < d.length || g || k) mxEdgeStyle.SegmentConnector(a, b, c, d, e); else {
            ...
            null != l && (c[0] = mxUtils.getPortConstraints(l, a, !0, mxConstants.DIRECTION_MASK_ALL), b =
                mxUtils.getValue(l.style, mxConstants.STYLE_ROTATION, 0), 0 != b && (b = mxUtils.getBoundingBox(new mxRectangle(q, r, t, u), b), q = b.x, r = b.y, t = b.width, u = b.height));
            ...
            q = [[q, r, t, u], [x, y, B, A]];
            z = [f, z];
            for (v = 0; 2 > v; v++) mxEdgeStyle.limits[v][1] = q[v][0] - z[v], mxEdgeStyle.limits[v][2] =
                q[v][1] - z[v], mxEdgeStyle.limits[v][4] = q[v][0] + q[v][2] + z[v], mxEdgeStyle.limits[v][8] = q[v][1] + q[v][3] + z[v];
            z = q[0][1] + q[0][3] / 2;
            r = q[1][1] + q[1][3] / 2;
            ...
            null != l && (r = n);
            l = [[.5, .5], [.5, .5]];
            for (v = 0; 2 > v; v++) null != r && (l[v][0] = (r.x - q[v][0]) / q[v][2], 1 >= Math.abs(r.x - q[v][0]) ? b[v] = mxConstants.DIRECTION_MASK_WEST : 1 >= Math.abs(r.x - q[v][0] - q[v][2]) && (b[v] = mxConstants.DIRECTION_MASK_EAST), l[v][1] = (r.y - q[v][1]) / q[v][3], 1 >= Math.abs(r.y -
                q[v][1]) ? b[v] = mxConstants.DIRECTION_MASK_NORTH : 1 >= Math.abs(r.y - q[v][1] - q[v][3]) && (b[v] = mxConstants.DIRECTION_MASK_SOUTH)), r = null, null != m && (r = p);
            v = q[0][1] - (q[1][1] + q[1][3]);
            p = q[0][0] - (q[1][0] + q[1][2]);
            r = q[1][1] - (q[0][1] + q[0][3]);
            t = q[1][0] - (q[0][0] + q[0][2]);
            ...
            m = [];
            n = [];
            m[0] = p >= t ? mxConstants.DIRECTION_MASK_WEST :
            ...
            0 < r && 0 < p && (0 < (m[0] & c[0]) && 0 < (n[1] & c[1]) ? (t[0][0] = m[0], t[0][1] = n[0], t[1][0] = n[1], t[1][1] = m[1],
                u = !0) : 0 < (n[0] & c[0]) && 0 < (m[1] & c[1]) && (t[0][0] = n[0], t[0][1] = m[0], t[1][0] = m[1], t[1][1] = n[1], u = !0));
            0 < r && !u && (t[0][0] = n[0], t[0][1] = m[0], t[1][0] = n[1], t[1][1] = m[1], u = !0);
            0 < p && !u && (t[0][0] = m[0], t[0][1] = n[0], t[1][0] = m[1], t[1][1] = n[1]);
            for (v = 0; 2 > v; v++) 0 == b[v] && (0 == (t[v][0] & c[v]) && (t[v][0] = t[v][1]), C[v] = t[v][0] & c[v], C[v] |= (t[v][1] & c[v]) << 8, C[v] |= (t[1 - v][v] & c[v]) << 16, C[v] |= (t[1 - v][1 - v] & c[v]) << 24, 0 == (C[v] & 15) && (C[v] <<= 8), 0 == (C[v] & 3840) && (C[v] = C[v] & 15 | C[v] >> 8), 0 == (C[v] & 983040) && (C[v] = C[v] & 65535 | (C[v] & 251658240) >>
                8), b[v] = C[v] & 15, c[v] == mxConstants.DIRECTION_MASK_WEST || c[v] == mxConstants.DIRECTION_MASK_NORTH || c[v] == mxConstants.DIRECTION_MASK_EAST || c[v] == mxConstants.DIRECTION_MASK_SOUTH) && (b[v] = c[v]);
            ...
            for (v = 0; v <= f && (v != f || ((0 < (b[1] & (mxConstants.DIRECTION_MASK_EAST |
                mxConstants.DIRECTION_MASK_WEST)) ? 0 : 1) == m ? 0 : 1) == (f + 1) % 2); v++) e.push(new mxPoint(Math.round(mxEdgeStyle.wayPoints1[v][0] * a.view.scale * 10) / 10, Math.round(mxEdgeStyle.wayPoints1[v][1] * a.view.scale * 10) / 10));
    ...
    getRoutePattern: function (a, b, c, d) {
        ...
        0 != c &&
        0 != d || null == inlineRoutePatterns[e - 1][a - 1] || (b = inlineRoutePatterns[e - 1][a - 1]);
        return b
    }
}, mxStyleRegistry = {
...
mxGraph.prototype.click = function (a) {
    ...
    if (this.isEnabled() && !mxEvent.isConsumed(b) && !d.isConsumed()) {
        if (null != c) {
            ...
            d = c;
            for (a = []; null != d;) {
                var d = this.model.getParent(d), f = this.view.getState(d);
                this.isSwimlane(d) && null != f && a.push(d)
            }
            if (0 < a.length) for (a = a.reverse(), a.splice(0, 0, c), a.push(c), d = 0; d < a.length - 1; d++) this.isCellSelected(a[d]) && (c = a[this.isToggleEvent(b) ? d : d + 1])
        }
...
mxGraph.prototype.alignCells = function (a, b, c) {
    ...
    if (null != b && 1 < b.length) {
        if (null == c) for (var d = 0; d < b.length; d++) {
            var e = this.getOriginForCell(b[d]), f = this.getCellGeometry(b[d]);
            if (!this.model.isEdge(b[d]) && null != f && !f.relative) if (null == c) if (a == mxConstants.ALIGN_CENTER) {
                c = e.x + f.x + f.width / 2;
                break
            } else if (a == mxConstants.ALIGN_RIGHT) c = e.x + f.x + f.width; else if (a == mxConstants.ALIGN_TOP) c = e.y + f.y; else if (a == mxConstants.ALIGN_MIDDLE) {
                c = e.y + f.y + f.height / 2;
                break
            } else c = a == mxConstants.ALIGN_BOTTOM ?
                e.y + f.y + f.height : e.x + f.x; else c = a == mxConstants.ALIGN_RIGHT ? Math.max(c, e.x + f.x + f.width) : a == mxConstants.ALIGN_TOP ? Math.min(c, e.y + f.y) : a == mxConstants.ALIGN_BOTTOM ? Math.max(c, e.y + f.y + f.height) : Math.min(c, e.x + f.x)
        }
        if (null != c) {
    ...
    if (null != a && 0 < a.length) {
        ...
        try {
            for (var c = 0; c < a.length; c++) {
                ...
                if (null != d && 0 < d.length) {
                    var d = d.slice(), e = this.model.getParent(a[c]), f = this.model.getChildCount(e);
                    this.cellsAdded(d, e, f, null, null, !0);
                    for (var b = b.concat(d), g = 0; g < d.length; g++) {
                        var k = this.view.getState(d[g]), l = this.getCellGeometry(d[g]);
...
mxGraph.prototype.addCells = function (a, b, c, d, e, f) {
    ...
    this.model.beginUpdate();
    try {
        this.cellsAdded(a, b, c, d, e, null != f ? f : !1, !0), this.fireEvent(new mxEventObject(mxEvent.ADD_CELLS, "cells", a, "parent", b, "static.index", c, "source", d, "target", e))
    } finally {
        this.model.endUpdate()
    }
    return a
...
mxGraph.prototype.cellsAdded = function (a, b, c, d, e, f, g, k) {
    if (null != a && null != b && null != c) {
        ...
        try {
            ...
            this.fireEvent(new mxEventObject(mxEvent.CELLS_ADDED, "cells", a, "parent", b, "static.index", c, "source",
...
mxGraph.prototype.splitEdge = function (a, b, c, d, e, f, g, k) {
    ...
    try {
        if (null == c) {
            c = this.cloneCell(a);
            var l = this.view.getState(a), m = this.getCellGeometry(c);
            if (null != m && null != m.points && null != l) {
                var n = this.view.translate, p = this.view.scale,
    ...
    if (null != a && (0 != b || 0 != c || d || null != e)) {
        ...
        try {
            ...
            for (var n = mxUtils.bind(this, function (a) {
                ...
                var q = this.getCellGeometry(a[m]), r = this.model.getParent(a[m]);
            ...
            if (null != e) {
                ...
                this.cellsAdded(a, e, u, null, null,
                    !0);
                if (d) for (m = 0; m < a.length; m++) q = this.getCellGeometry(a[m]), r = this.model.getParent(k[m]), null != q && q.relative && this.model.isEdge(r) && this.model.contains(r) && this.model.add(r, a[m])
            }
...
mxGraph.prototype.getCells = function (a, b, c, d, e, f, g, k, l) {
    f = null != f ? f : [];
    if (0 < c || 0 < d || null != g) {
        var m = this.getModel(), n = a + c, p = b + d;
        null == e && (e = this.getCurrentRoot(), null == e && (e = m.getRoot()));
        if (null != e) for (var q = m.getChildCount(e), r = 0; r < q; r++) {
            var t = m.getChildAt(e, r), u = this.view.getState(t);
...
mxGraph.prototype.fireMouseEvent = function (a, b, c) {
    if (this.isEventSourceIgnored(a, b)) null != this.tooltipHandler && this.tooltipHandler.hide(); else {
        ...
        if (!this.nativeDblClickEnabled && !mxEvent.isPopupTrigger(b.getEvent()) || this.doubleTapEnabled && mxClient.IS_TOUCH && (mxEvent.isTouchEvent(b.getEvent()) || mxEvent.isPenEvent(b.getEvent()))) {
            ...
            if (a == mxEvent.MOUSE_DOWN) if (null != this.lastTouchEvent && this.lastTouchEvent != b.getEvent() && d - this.lastTouchTime <
        ...
        if (!this.isEventIgnored(a, b, c)) {
            ...
            if (mxClient.IS_OP || mxClient.IS_SF || mxClient.IS_GC || mxClient.IS_IE11 || mxClient.IS_IE && mxClient.IS_SVG || b.getEvent().target != this.container) {
                if (a == mxEvent.MOUSE_MOVE && this.isMouseDown && this.autoScroll &&
                    !mxEvent.isMultiTouchEvent(b.getEvent)) this.scrollPointToVisible(b.getGraphX(), b.getGraphY(), this.autoExtend); else if (a == mxEvent.MOUSE_UP && this.ignoreScrollbars && this.translateToScrollPosition && (0 != this.container.scrollLeft || 0 != this.container.scrollTop)) {
                ...
                if (null != this.mouseListeners) for (d = [c, b], b.getEvent().preventDefault ||
...
mxOutline.prototype.update = function (a) {
    if (null != this.source && null != this.source.container && null != this.outline && null != this.outline.container) {
        ...
        if (0 < d) {
            ...
            var c = b.translate, d = this.source.getView().scale, f = d / b.scale, g = 1 / b.scale,
...
mxLayoutManager.prototype.cellsResized = function (a, b, c) {
    if (null != a && null != b) for (var d = this.getGraph().getModel(), e = 0; e < a.length; e++) {
        ...
        this.refreshThread = window.setTimeout(mxUtils.bind(this,
            function () {
                ...
                if (null != this.first && !this.suspended) {
                    var a = this.currentDx, b = this.currentDy;
...
mxGraphHandler.prototype.selectCellForEvent = function (a, b) {
    ...
    if (null != c) {
        if (!(b.isSource(c.control) || this.graph.isToggleEvent(b.getEvent()) && mxEvent.isAltDown(b.getEvent()))) for (var c = this.graph.getModel(), d = c.getParent(a); null != this.graph.view.getState(d) && (c.isVertex(d) || c.isEdge(d)) && this.isPropagateSelectionCell(a, !1, b);) a = d, d = c.getParent(a);
        ...
        if (0 == c.length) this.reset(); else {
            for (var d = this.graph.view.scale, e = 0; e < c.length; e++) {
                ...
                if (this.graph.model.isEdge(f.cell)) {
                    ...
                    if (null != g && null != g.points) for (var l = 0; l < g.points.length; l++) null != g.points[l] && k.push(new mxPoint(g.points[l].x + a / d, g.points[l].y + b / d));
...
mxGraphHandler.prototype.setHandlesVisibleForCells = function (a, b, c) {
    if (c || this.handlesVisible != b) for (this.handlesVisible = b, c = 0; c < a.length; c++) {
    ...
    if (!b.isConsumed()) if (this.livePreviewUsed && this.resetLivePreview(), null == this.cell || null == this.first || null == this.shape && !this.livePreviewUsed || null == this.currentDx || null == this.currentDy) this.isSelectEnabled() && this.delayedSelection && null != this.cell && this.selectDelayed(b); else {
        ...
        if (this.connectOnDrop && null == this.target && null != d && c.getModel().isVertex(d) && c.isCellConnectable(d) && c.isEdgeValid(null, this.cell, d)) c.connectionHandler.connect(this.cell,
            ...
            var d = c.isCloneEvent(b.getEvent()) && c.isCellsCloneable() && this.isCloneEnabled(),
                e = c.getView().scale, f = this.roundLength(this.currentDx / e),
                e = this.roundLength(this.currentDy / e), g = this.target;
...
mxRubberband.prototype.mouseMove = function (a, b) {
    if (!b.isConsumed() && null != this.first) {
        ...
        c.x -= d.x;
        c.y -= d.y;
        var d = b.getX() + c.x, c = b.getY() + c.y, e = this.first.x - d, f = this.first.y - c,
...
mxVertexHandler.prototype.getHandleForEvent = function (a) {
    ...
    if (null != this.sizers) for (var d = 0; d < this.sizers.length; d++) if (b(this.sizers[d])) return d;
    if (null != this.customHandles && this.isCustomHandleEvent(a)) for (d = this.customHandles.length - 1; 0 <= d; d--) if (b(this.customHandles[d].shape)) return mxEvent.CUSTOM_HANDLE - d;
    return null
};
...
mxVertexHandler.prototype.start = function (a, b, c) {
    if (null != this.selectionBorder) if (this.livePreviewActive = this.livePreview && 0 == this.graph.model.getChildCount(this.state.cell), this.inTolerance = !0, this.childOffsetY = this.childOffsetX = 0, this.index = c, this.startX = a, this.startY = b, this.index <= mxEvent.CUSTOM_HANDLE && this.isGhostPreview()) this.ghostPreview = this.createGhostPreview(); else {
        ...
        if (this.livePreviewActive) for (this.hideSizers(), c == mxEvent.ROTATION_HANDLE ? this.rotationShape.node.style.display = "" : c == mxEvent.LABEL_HANDLE ? this.labelShape.node.style.display = "" : null != this.sizers &&
...
mxVertexHandler.prototype.mouseUp = function (a, b) {
    if (null != this.index && null != this.state) {
        ...
        try {
            if (d <= mxEvent.CUSTOM_HANDLE) {
            ...
            } else if (d == mxEvent.ROTATION_HANDLE) if (null != this.currentAlpha) {
                ...
                var g = this.graph.isGridEnabledEvent(b.getEvent()),
                    ...
                    l = Math.cos(-k), m = Math.sin(-k), n = c.x - this.startX, p = c.y - this.startY, c = m * n + l * p,
                    n = l * n - m * p, p = c, q = this.graph.view.scale, r = this.isRecursiveResize(this.state, b);
        ...
        if (this.singleSizer) this.moveSizerTo(this.sizers[0], b, c); else {
            ...
            if (8 <= this.sizers.length) {
                var f =
                    ...
                    l = Math.sin(g), g = Math.round(4 * g / Math.PI), m = new mxPoint(a.getCenterX(), a.getCenterY()),
...
mxVertexHandler.prototype.updateParentHighlight = function () {
    if (!this.isDestroyed()) {
        var a = this.isParentHighlightVisible(), b = this.graph.model.getParent(this.state.cell),
...
mxVertexHandler.prototype.destroy = function () {
    ...
    if (null != this.parentHighlight) {
        var a = this.graph.model.getParent(this.state.cell), a = this.graph.view.getState(a);
...
mxEdgeHandler.prototype.getHandleForEvent = function (a) {
    ...
    if (null != this.state) {
        ...
        if (null != this.customHandles && this.isCustomHandleEvent(a)) for (d = this.customHandles.length - 1; 0 <= d; d--) if (c(this.customHandles[d].shape)) return mxEvent.CUSTOM_HANDLE - d;
        if (a.isSource(this.state.text) || c(this.labelShape)) b = mxEvent.LABEL_HANDLE;
        if (null != this.bends) for (d = 0; d < this.bends.length; d++) c(this.bends[d]) && (b = d);
        if (null != this.virtualBends && this.isAddVirtualBendEvent(a)) for (d = 0; d < this.virtualBends.length; d++) c(this.virtualBends[d]) && (b = mxEvent.VIRTUAL_HANDLE -
            d)
    }
    return b
};
...
mxEdgeHandler.prototype.updatePreviewState = function (a, b, c, d, e) {
    var f = this.isSource ? c : this.state.getVisibleTerminalState(!0),
        ...
        k = this.graph.getConnectionConstraint(a, f, !0), l = this.graph.getConnectionConstraint(a, g, !1),
    ...
    if (null != this.index && null != this.marker) {
        ...
        this.customHandles && (this.customHandles[mxEvent.CUSTOM_HANDLE - this.index].processEvent(b), this.customHandles[mxEvent.CUSTOM_HANDLE - this.index].positionChanged(), null != this.shape && null != this.shape.node && (this.shape.node.style.display = "none")); else if (this.isLabel) this.label.x = this.currentPoint.x, this.label.y = this.currentPoint.y; else {
            ...
            if (null != this.constraintHandler.currentConstraint &&
                null != this.constraintHandler.currentFocus && null != this.constraintHandler.currentPoint) this.currentPoint = this.constraintHandler.currentPoint.clone(); else if (this.outlineConnect) {
...
mxEdgeHandler.prototype.mouseUp = function (a, b) {
    if (null != this.index && null != this.marker) {
        ...
        if (b.getX() != this.startX || b.getY() != this.startY) {
            ...
            if (null != this.error) 0 < this.error.length && this.graph.validationAlert(this.error); else if (d <= mxEvent.CUSTOM_HANDLE &&
            ...
            } else if (this.isLabel) this.moveLabel(this.state, this.label.x, this.label.y); else if (this.isSource || this.isTarget) if (d = null, null != this.constraintHandler.currentConstraint && null != this.constraintHandler.currentFocus && (d = this.constraintHandler.currentFocus.cell),
...
mxEdgeSegmentHandler.prototype.getPreviewPoints = function (a) {
    ...
    if (1 == d.length) {
        var b = this.state.getVisibleTerminalState(!0),
            c = this.state.getVisibleTerminalState(!1), f = this.state.view.getScale(),
            g = this.state.view.getTranslate(), e = d[0].x * f + g.x, f = d[0].y * f + g.y;
...
mxCellHighlight.prototype.isHighlightAt = function (a, b) {
    var c = !1;
    if (null != this.shape && null != document.elementFromPoint) for (var d = document.elementFromPoint(a, b); null != d;) {
